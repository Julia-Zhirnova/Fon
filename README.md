...
1. Хранитель экрана: убрать галочку у "Запускать хранитель экрана, когда компьютер простаивает" и "Блокировать экран, когда запущен хранитель экрана"  
   <br><img src="https://github.com/user-attachments/assets/668bec36-3718-4828-8611-fb20b467a965" height="400" />

3. Управление питанием: можно выбрать
Действия
...
4. Сочетания клавиш клавиатуры: можно настроить:
...
5. Окно настройки РЕД ОС: убрать галочку у Показывать это окно при загрузке системы
